    ...
    <Link href={`/chefs/${chef.id}`}>
      <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 hover:border-green-200 overflow-hidden group">
        <div className="p-4 text-center sm:p-6">
          ...
          {/* Rating Badge */}
          <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-green-50 text-green-700 px-3 py-1.5 rounded-full text-sm font-semibold mb-3 border border-green-200">
            <svg
              className="w-4 h-4 mr-1 fill-current text-green-500"
              viewBox="0 0 20 20"
            >
